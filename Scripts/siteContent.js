 ...
 * Tambien define las rutas de las 5 imagenes del carrusel de Dr. Chasis.
 */
...
export const siteContent = {
  es: {
    ...
    hero: {
      ...
      brandName: "Laboratorio Clínico Dr. Chasis",
      description:
  ...
  en: {
    ...
    hero: {
      ...
      brandName: "Dr. Chasis Clinical Laboratory",
      description:
